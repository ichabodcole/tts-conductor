...
- 2026-05-23 sessions (`docs/sessions/2026-05-23-*.md`) — context on what shipped in alpha.0
- `docs/deferred-items.md` — broader deferred backlog (audio primitives, usage reporting, Bucket C polish live here)
