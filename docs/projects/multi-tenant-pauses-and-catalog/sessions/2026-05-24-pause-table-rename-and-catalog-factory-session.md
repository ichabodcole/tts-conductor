...
- Dev plan: `../plan.md`
- Dev kickoff: `../DEV_KICKOFF.md` (during the original implementation it lived at the repo root, then briefly under `docs/proposals/`, and now lives alongside the proposal post-doc-migration)
