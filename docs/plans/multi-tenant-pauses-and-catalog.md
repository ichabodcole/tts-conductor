...
**Source proposal:** `docs/proposals/multi-tenant-pauses-and-catalog.md`
...
- Session doc in `docs/sessions/2026-05-DD-pause-table-rename-and-catalog-factory-session.md` (use today's date when implementing).
...
- Read the source proposal at `docs/proposals/multi-tenant-pauses-and-catalog.md`.
...
- Read the existing `tts-conductor-migration` session docs under `docs/sessions/2026-05-23-*.md` if context on the existing per-call-override implementation would help — particularly `2026-05-23-per-call-overrides-session.md` if it exists.
